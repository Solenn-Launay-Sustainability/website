...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: The div here is used as a generic container for various field types.
    <div
  ...
  return (
    ...
    >
      <div
        aria-hidden={!open}
        className={cn(
          "overflow-hidden font-normal text-destructive text-sm",
          className,
        )}
        role="alert"
      >
